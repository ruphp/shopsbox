...
final readonly class HostStorefrontController
{
    ...
    #[Route('/', name: 'host_storefront_home', host: '{storeSlug}.shopsbox.ru', methods: ['GET'])]
    #[Route('/', name: 'local_host_storefront_home', host: '{storeSlug}.shopsbox.local', methods: ['GET'])]
    ...
    #[Route('/products', name: 'host_storefront_products', host: '{storeSlug}.shopsbox.ru', methods: ['GET'])]
    #[Route('/products', name: 'local_host_storefront_products', host: '{storeSlug}.shopsbox.local', methods: ['GET'])]
    ...
    #[Route('/categories/{categorySlug}', name: 'host_storefront_category', host: '{storeSlug}.shopsbox.ru', methods: ['GET'])]
    #[Route('/categories/{categorySlug}', name: 'local_host_storefront_category', host: '{storeSlug}.shopsbox.local', methods: ['GET'])]
    ...
    #[Route('/products/{productSlug}', name: 'host_storefront_product', host: '{storeSlug}.shopsbox.ru', methods: ['GET'])]
    #[Route('/products/{productSlug}', name: 'local_host_storefront_product', host: '{storeSlug}.shopsbox.local', methods: ['GET'])]
