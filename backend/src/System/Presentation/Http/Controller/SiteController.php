        ...
        return [
            'privacy' => [
                ...
                'paragraphs' => [
                    ...
                    'Пользователь может в любой момент запросить удаление или изменение своих данных, обратившись в службу поддержки по email ruphp@mail.ru.',
            ...
            'terms' => [
                ...
                'paragraphs' => [
                    $operator,
                    'Используя shopsbox.ru, пользователь соглашается с настоящими условиями. Платформа предоставляет инструменты для создания интернет-магазинов на поддоменах.',
