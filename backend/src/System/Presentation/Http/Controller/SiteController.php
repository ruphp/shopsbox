        ...
        return [
            'free' => [
                ...
                'limits' => [
                    ...
                    'на бесплатном тарифе могут показываться рекламные места ShopsBox',
    ...
    private function staticPages(): array
    {
        ...
        return [
            ...
            'contacts' => [
                ...
                'description' => 'Контакты ShopsBox для юридических и финансовых вопросов.',
                'paragraphs' => [
                    'Ответственный за сервис: Александр Викторович Смирнов.',
