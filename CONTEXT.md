...
- DDD.
- SOLID.
- Модульный монолит: один Symfony backend, доменные области разложены по модулям без выделения микросервисов на MVP.
- Структура backend-модуля: `Domain`, `Application`, `Infrastructure`, `Presentation`.
- Multi-tenancy.
