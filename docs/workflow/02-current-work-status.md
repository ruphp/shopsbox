...
- Название: `Локальные операции: планировщик, заготовки бэкапов и проверки здоровья`
- Статус: `В работе локально`
- Локальная ветка: `task/04-local-operations-foundation`
- Этап: `01 Основа MVP`
- Удаленная задача: `https://github.com/ruphp/shopsbox/issues/4`
...
- `#4 Локальные операции: планировщик, заготовки бэкапов и проверки здоровья` - `В работе локально` в ветке `task/04-local-operations-foundation`;
...
- Задача `#4` взята в локальную работу в ветке `task/04-local-operations-foundation`.
- Задача `#5` лежит в `Бэклог`.
...
Статус: локальная реализация `#4` начата в ветке `task/04-local-operations-foundation`.
