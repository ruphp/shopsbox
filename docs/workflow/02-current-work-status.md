...
- Название: `Основа учета ресурсов и лимитов`
- Статус: `В работе локально`
- Локальная ветка: `task/05-resource-usage-foundation`
- Этап: `01 Основа MVP`
- Удаленная задача: `https://github.com/ruphp/shopsbox/issues/5`
...
- `#5 Основа учета ресурсов и лимитов` - `В работе локально` в ветке `task/05-resource-usage-foundation`.
...
- Задача `#5` взята в локальную работу в ветке `task/05-resource-usage-foundation`.
...
Статус: локальная реализация `#5` начата в ветке `task/05-resource-usage-foundation`.
